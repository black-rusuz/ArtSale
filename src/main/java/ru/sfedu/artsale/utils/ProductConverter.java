...
public class ProductConverter extends AbstractBeanField<Product, String> {
    ...
    public String convertToWrite(Object object) {
        List params;
        if (object.getClass().equals(CreationKit.class)) {
            CreationKit creationKit = (CreationKit) object;
        ...
        else if (object.getClass().equals(EndProduct.class)) {
            EndProduct endProduct = (EndProduct) object;
